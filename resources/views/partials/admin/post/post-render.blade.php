...
<div id="reply-render-viewer" class="global-viewer full-center none" style="z-index: 55555">
    <div class="close-button-style-1 close-global-viewer unselectable">✖</div>
    <div class="global-viewer-content-box viewer-box-style-1" style="margin-top: -26px; width: 580px;">
        <div class="flex align-center space-between light-gray-border-bottom" style="padding: 14px;">
            <span class="fs18 bold forum-color flex align-center">
                ...
                <a href="" target="_blank" class="wtypical-button-style width-max-content no-underline bold lblack fs11" style="padding: 3px 8px">
        ...
        <div id="reply-render-box" class="y-auto-overflow" style="padding: 14px; max-height: 450px;">
